...
//     // Updated with new modern season images
//     setSeasons([
//       {
//         id: 1,
//         title: "Spring",
...
//                     e.currentTarget.style.boxShadow = "0 6px 12px rgba(74, 144, 226, 0.3)"
//                   }}
//                   onMouseOut={(e) => {
//                     e.currentTarget.style.backgroundColor = "#4a90e2"
//                     e.currentTarget.style.transform = "translateY(0)"
//                     e.currentTarget.style.boxShadow = "0 4px 6px rgba(74, 144, 226, 0.2)"
//                   }}
//                 >
//                   Submit Product
//                 </button>
  ...
  useEffect(() => {
    const fetchDashboard = async () => {
      try {
        ...
        const counts = await fetchProductCounts(token)
